...

    {
        ...
        config = function()
            require("mason-nvim-dap").setup({
                -- delve (Go debugger) removed: requires a Go toolchain to build,
                -- which isn't installed, so mason retried the install every startup.
                -- To re-enable Go debugging: install Go, then add "delve" back here.
                ensure_installed = {},
